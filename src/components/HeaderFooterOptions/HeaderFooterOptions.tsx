...
import App, { Module, typeFH } from "../../store/Application";

import { CustomHook } from "../CustomHook";

export const HeaderFooterOptions = observer(
  <_, T>({ options, name, namePrivate }: Pick<Module, "options" | "name" | "namePrivate">) => {
    ...
    React.useEffect(() => {
      App.changeOptionHeaderFooter(FH, { backgroundColor: inputBgcColor.value });
    }, [inputBgcColor]);
    React.useEffect(() => {

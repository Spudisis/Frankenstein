...
import { ButtonClose, Info, Modal, ModalContent } from './ModalAccessEmail.styles'
  ...
  return (
    <Modal onClick={handleClickOutside}>
      <ModalContent ref={ref}>
        ...
        <Info>Вы зарегистрированы, проверьте почту для подтверждения: {AuthStore.user?.email}</Info>
      </ModalContent>
    </Modal>
  )
})

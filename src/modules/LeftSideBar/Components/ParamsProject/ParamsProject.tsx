...
import { ModalTypes } from "./ParamsProject.types";
...
export const Modal = observer(
  ({ closeModal, action, nameProject }: ModalTypes) => {
        ...
        {createPortal(
          <BgcModal onClick={onClickModal}>
            <ModalStyled ref={ref}>
              <Content>
                <p>
                  Необходимо дополнительное подтверждение. Для удаления проекта
                  введите "{nameProject}" ниже:
                </p>
                {error && (
                  <Error>
                    {errorStatus
                ...
                <div>
                  ...
                  <DefaultButton
                    ...
                    disabled={loadStatus}
                  />
                  <CloseModalStyled onClick={() => closeModal(false)}>

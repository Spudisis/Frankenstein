...
import { type ChangeOptions, type SubModules } from 'src/domains'
    ...
    return (
      <>
        <Input<HFStyles>
          ...
          typeInput="text"
        />
        <Input<HFStyles> label="Высота:" value={styles} onChange={ChangeStyles} property="height" typeInput="text" />
        <Input<HFStyles> label="Бордер:" value={styles} onChange={ChangeStyles} property="border" typeInput="text" />
